 ...
 * Runs the processor bound threads first and the IO bound second. 
 * 
 * @author - Alice Stanford
 * @since 2017-06-07
 */

//NEED TO DO : WAIT TIME FOR ALL CONTROLLERS AS WELL AS AVERAGE WAIT TIME
...
public class Controller3 {
    ...
    public static ThreadsTimes threadTime(ThreadAbstract threadIO[], ThreadAbstract threadComp[]) throws InterruptedException {
        ...
        for (int i = 0; i < threadComp.length; i++){
        	threadComp[i].start();
            threadComp[i].join();
        }
